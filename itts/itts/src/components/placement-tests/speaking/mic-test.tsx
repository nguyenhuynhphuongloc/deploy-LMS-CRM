 ...
 * @param {() => void} props.onStopRecording The function to call when the user clicks the stop button.
 * @param {() => void} props.onStartRecording The function to call when the user clicks the start button.
    ...
    <div className="flex justify-center items-center h-screen">
      <div className="gap-[40px] flex-col flex justify-center items-center py-15 w-[1038px] h-[478px] bg-white shadow-[0px_0px_60px_0px_rgba(0,0,0,0.05)] rounded-[26px]">
        ...
        <div className="flex gap-6">
          ...
          {audioURL ? (
            <Button onClick={() => setDoneTest(true)}>
              Start Exam <LogInIcon />
            </Button>
          ) : (
            <Button variant="secondary" onClick={() => setDoneTest(true)}>
