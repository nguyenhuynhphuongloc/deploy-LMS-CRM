...
export interface Feature {
  ...
  floatingAnchorElemPlugins?: Array<
    (floatingAnchorElem: HTMLDivElement) => JSX.Element
  >; // Plugins which are put in the floating anchor element (the thing which appears when you select text)
  ...
  toolbar?: {
    ...
    insert?: Array<
      (editor: LexicalEditor, editorConfig: EditorConfig) => JSX.Element
    >;
    normal?: Array<
      (
