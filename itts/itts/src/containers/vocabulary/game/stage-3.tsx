 ...
 */
export default function Stage3({ data, setStage }: Stage1Props): JSX.Element {
  ...
  // Shuffle words once when component mounts
  useEffect(() => {
    setShuffledWords(shuffleArray(data));
  }, [data]);

  // Generate new options each time the question changes
  useEffect(() => {
  ...
  return (
    <div>
      <p className="mt-6 text-2xl font-bold">Stage 3 - Speed read 1</p>
      <div
